#ifndef TXTTREEMODEL_H
#define TXTTREEMODEL_H
...
private:
    ...
    // собираем дерево из txt-файла (ответ DVL на команду "params print: ep")
    void setupModelData_new(const QStringList &lines, TreeItem *parent);
};

#endif // TXTTREEMODEL_H
